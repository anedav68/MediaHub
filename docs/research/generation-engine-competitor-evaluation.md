...
## 0. How to read this document, and how it relates to the existing dissertation

MediaHub already has a competitor document: `docs/competitor_dissertation_2026.md` (~10,000 words, May 2026). That dissertation is a **business-landscape and go-to-market study** — ten "shape" competitors (Holo, Blaze, Predis, Ocoya, Lately, Jasper, Postwise, Nota, FanWord, Greenfly), evaluated on input modality, intelligence layer, distribution and commercial model, ending in a Parity → Distinction → Leadership roadmap. It answers *"can MediaHub compete as a business, and on what terms?"*

This document answers a **different and more technical question**, the one the brief actually poses: *"how do the best content-generation tools mechanically produce graphics, video and captions — and why does MediaHub's current 'click generate' produce something boring and samey?"* It is a **generation-mechanics** study, not a market-positioning study. Where the dissertation talks about brand-DNA capture as a *go-to-market* primitive, this document dissects the *rendering pipeline, the model architecture, the variation engine, and the cost-per-asset* of each approach. The two are complementary; the companion thesis (`docs/research/mediahub-generative-ai-thesis.md`) builds the surgical plan on top of both.
